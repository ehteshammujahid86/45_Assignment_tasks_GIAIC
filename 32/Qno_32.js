...
var current_users = ['umer', 'daniyal', 'nabeel', 'sajeel', 'asif'];
var new_users = ['umer123', 'daniyal12', 'nabeel', 'sajeel', 'asif00'];
for (var i = 0; i < new_users.length; i++) {
    if (current_users[i] === new_users[i]) {
        console.log("Mr ".concat(new_users[i], ", you will need to enter new username"));
    }
    else {
        console.log("Mr ".concat(new_users[i], " ,username is available"));
    }
}
