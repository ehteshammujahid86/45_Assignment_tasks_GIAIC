...
for (var i = 0; i < ordinal_num.length; i++) {
    if (ordinal_num[i] === 1) {
        console.log("".concat(ordinal_num[i], "st number \n"));
    }
    else if (ordinal_num[i] === 2) {
        console.log("".concat(ordinal_num[i], "nd number \n"));
    }
    else if (ordinal_num[i] === 3) {
        console.log("".concat(ordinal_num[i], "rd number \n"));
    }
    else {
        console.log("".concat(ordinal_num[i], "th number} \n"));
    }
}
